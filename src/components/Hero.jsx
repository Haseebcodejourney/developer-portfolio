...
const Hero = () => {
  ...
  useEffect(() => {
    const textArray = profile.typingRoles;
  ...
  return (
    <section className="container main-section" id="main-section">
      <div className="row main-section-inner">
        <div className="col-lg-7 col-md-7 col-sm-12 intro-section">
                    ...
                    <ul>
                      ...
                      <li className="whatsapp">
                        <a
                          ...
                          aria-label="WhatsApp"
                        >
                          <svg fill="#000000" height="24px" width="24px" viewBox="0 0 308 308">
                            <g>
        ...
        <div className="col-lg-5 col-md-5 intro-image">
